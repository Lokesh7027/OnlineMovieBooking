...
public class SearchMovieServiceImpl {
    ...
    public SearchMovieResp getMovieSearchDeatails(SearchMovieReq searchMovieReq) {
        ...
        searchMovieResp.setResultCode(0);
        searchMovieResp.setMessage("success");
        searchMovieResp.setTotalRecords(2L);
        searchMovieResp.setOffset(searchMovieReq.getOffset());
        searchMovieResp.setLimit(searchMovieReq.getLimit());
